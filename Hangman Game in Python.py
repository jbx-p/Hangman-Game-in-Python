...
# If the user has entered a non-alpha character, the program will prompt them to enter a valid letter.
# The program also checks to see if the user has entered a single letter or multiple letters.
